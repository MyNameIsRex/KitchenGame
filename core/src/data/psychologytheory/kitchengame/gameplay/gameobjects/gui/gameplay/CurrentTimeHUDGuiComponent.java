...
public class CurrentTimeHUDGuiComponent extends HUDGuiComponent {
    public CurrentTimeHUDGuiComponent(int objID, float objWidth, float objHeight, float objPosX, float objPosY, String objName, int zIndex) {
        ...
        this.setDisplayPartialTextures(new TextureRegion[]{AssetUtil.getInstance().createPartialTexture(AssetList.GUI_ICONS.getTexture(), 32, 0, 32, 32)});
        ...
        this.setDisplayTexts(new String[]{"12 : 00"});
    }
