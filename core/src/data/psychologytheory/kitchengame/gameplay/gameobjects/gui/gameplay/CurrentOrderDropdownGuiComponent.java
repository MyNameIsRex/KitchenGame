...
public class CurrentOrderDropdownGuiComponent extends ButtonGuiComponent {
    private boolean showDropdown = false;
    public CurrentOrderDropdownGuiComponent(int objID, float objWidth, float objHeight, float objPosX, float objPosY, String objName, int zIndex) {
        ...
        this.setDisplayPartialTextures(new TextureRegion[]{AssetUtil.getInstance().createPartialTexture(AssetList.GUI_ICONS.getTexture(), 0, 0, 32, 32)});
        ...
        this.setDisplayTexts(new String[]{"Orders"});
        this.setClickListener(() -> this.showDropdown = !this.showDropdown);
    }
    ...
    public void render() {
        ...
        if (this.showDropdown) {
            RenderUtil.getInstance().renderFilledShape((int )this.getObjPosX(), (int) this.getObjPosY() - 96, 128, 96, this.getDisplayColors()[2]);
        }
    }
}
