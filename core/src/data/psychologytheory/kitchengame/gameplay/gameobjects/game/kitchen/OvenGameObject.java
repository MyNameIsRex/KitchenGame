...
public class OvenGameObject extends InteractableGameObject {
    ...
    public void runInteraction() {
        this.isOvenDoorOpen = MouseInput.getMousePosX() >= this.getObjPosX() && MouseInput.getMousePosX() <= this.getObjPosX() + this.getObjWidth() &&
                MouseInput.getMousePosY() <= this.getObjPosY() + this.getObjHeight() + 32 && MouseInput.getMousePosY() >= this.getObjPosY();
