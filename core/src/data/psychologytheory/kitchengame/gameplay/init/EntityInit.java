...
public class EntityInit implements IContent {
    ...
    public void createContents() {
        EntityList.CHEF.setCharacterInstance(new ChefEntity(0, 32, 64, 512, 344, "chef_entity",
        ...
        EntityList.LINE_COOK_MEAT.setCharacterInstance(new LineCookEntity(5, 32, 64, 736, 344, "line_cook_meat_entity",
                AssetList.KITCHEN_LINE_COOK.getTexture(), AssetUtil.getInstance().createUniformPartialTextures(AssetList.KITCHEN_LINE_COOK.getTexture(), 0, 0, 64, 128, 16, 16, 1),
                2, 3F, 3F,
